namespace ProvaiderEF
{
    partial class FormMenuManager
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnContract = new FontAwesome.Sharp.IconButton();
            btnSubscriber = new FontAwesome.Sharp.IconButton();
            btnEquipment = new FontAwesome.Sharp.IconButton();
            btnTariff = new FontAwesome.Sharp.IconButton();
            btnZone = new FontAwesome.Sharp.IconButton();
            ...
            btnContract.Font = new Font("Century Gothic", 9F, FontStyle.Regular, GraphicsUnit.Point);
            btnContract.ForeColor = Color.Gainsboro;
            btnContract.IconChar = FontAwesome.Sharp.IconChar.AddressCard;
            btnContract.IconColor = Color.Gainsboro;
            btnContract.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnContract.IconSize = 32;
            btnContract.ImageAlign = ContentAlignment.MiddleLeft;
            btnContract.Location = new Point(0, 440);
            btnContract.Name = "btnContract";
            btnContract.Padding = new Padding(10, 0, 20, 0);
            btnContract.Size = new Size(368, 60);
            btnContract.TabIndex = 6;
            btnContract.Text = "Договоры";
            ...
            // btnSubscriber
            // 
            btnSubscriber.Dock = DockStyle.Top;
            btnSubscriber.FlatAppearance.BorderSize = 0;
            btnSubscriber.FlatStyle = FlatStyle.Flat;
            btnSubscriber.Font = new Font("Century Gothic", 9F, FontStyle.Regular, GraphicsUnit.Point);
            btnSubscriber.ForeColor = Color.Gainsboro;
            btnSubscriber.IconChar = FontAwesome.Sharp.IconChar.Person;
            btnSubscriber.IconColor = Color.Gainsboro;
            btnSubscriber.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnSubscriber.IconSize = 32;
            btnSubscriber.ImageAlign = ContentAlignment.MiddleLeft;
            btnSubscriber.Location = new Point(0, 380);
            btnSubscriber.Name = "btnSubscriber";
            btnSubscriber.Padding = new Padding(10, 0, 20, 0);
            btnSubscriber.Size = new Size(368, 60);
            btnSubscriber.TabIndex = 5;
            btnSubscriber.Text = "Абоненты";
            btnSubscriber.TextAlign = ContentAlignment.MiddleLeft;
            btnSubscriber.TextImageRelation = TextImageRelation.ImageBeforeText;
            ...
            btnEquipment.Location = new Point(0, 320);
            ...
            btnTariff.Location = new Point(0, 260);
            ...
            // btnZone
            // 
            btnZone.Dock = DockStyle.Top;
            btnZone.FlatAppearance.BorderSize = 0;
            btnZone.FlatStyle = FlatStyle.Flat;
            btnZone.Font = new Font("Century Gothic", 9F, FontStyle.Regular, GraphicsUnit.Point);
            btnZone.ForeColor = Color.Gainsboro;
            btnZone.IconChar = FontAwesome.Sharp.IconChar.Map;
            btnZone.IconColor = Color.Gainsboro;
            btnZone.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnZone.IconSize = 32;
            btnZone.ImageAlign = ContentAlignment.MiddleLeft;
            btnZone.Location = new Point(0, 200);
            btnZone.Name = "btnZone";
            btnZone.Padding = new Padding(10, 0, 20, 0);
            btnZone.Size = new Size(368, 60);
            btnZone.TabIndex = 2;
            btnZone.Text = "Зона покрытия";
            btnZone.TextAlign = ContentAlignment.MiddleLeft;
            btnZone.TextImageRelation = TextImageRelation.ImageBeforeText;
            btnZone.UseVisualStyleBackColor = true;
            ...
            btnMinimize.Location = new Point(1719, 12);
            ...
            btnMaximize.Location = new Point(1768, 12);
            ...
            pictureBoxLogo.Location = new Point(719, 654);
            ...
            lblName.Location = new Point(695, 426);
            ...
            lblHello.Location = new Point(648, 338);
        ...
        private FontAwesome.Sharp.IconButton btnSubscriber;
