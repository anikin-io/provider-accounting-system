...
namespace ProvaiderEF.MyControls
{
    public class CustomTimePicker : DateTimePicker
    {
        ...
        public CustomTimePicker()
        {
            ...
            CustomFormat = "HH:mm"; // Формат времени
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                // Увеличиваем размер прямоугольника для закраски фона
            ...
            using (SolidBrush textBrush = new SolidBrush(textColor))
            {
                ...
                format.Alignment = StringAlignment.Near; // Выравнивание текста по левому краю
