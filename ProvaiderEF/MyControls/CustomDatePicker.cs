...
namespace ProvaiderEF.MyControls
{
    public class CustomDatePicker: DateTimePicker
    {
        ...
        public CustomDatePicker()
        {
            ...
            this.Resize += CustomDatePicker_Resize; // Обработчик события изменения размера
            this.Height = 60; // Установка высоты в 60 пикселей
        }

        private void CustomDatePicker_Resize(object sender, EventArgs e)
        {
            SendMessage(this.Handle, DTM_SETMCTIMEHEIGHT, 60, 0); // Установка новой высоты DateTimePicker
        }

        private const int DTM_FIRST = 0x1000;
        private const int DTM_SETMCTIMEHEIGHT = DTM_FIRST + 5;
