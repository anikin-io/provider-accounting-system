...
namespace ProvaiderEF.MyControls
{
    ...
    public class CustomComboBox: UserControl
    {
        ...
        // Добавление поддержки свойства SelectedValue
        ...
        public object SelectedValue
        {
            get
            {
                ...
                else if (cmbList.SelectedItem != null && !string.IsNullOrEmpty(ValueMember))
                {
                    var prop = cmbList.SelectedItem.GetType().GetProperty(ValueMember);
                    if (prop != null)
                        return prop.GetValue(cmbList.SelectedItem);
                }
                return null;
            }
            set
            {
                ...
                {
                    foreach (var item in cmbList.Items)
                    {
